  ...
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavGroup toggleIcon={faStar} toggleText="Icons">
        {/* <SidebarNavItem href="#">Icons</SidebarNavItem> */}
        <SidebarNavItem href="#">Icons - Brand</SidebarNavItem>
        <SidebarNavItem href="#">Icons - Flag</SidebarNavItem>
      </SidebarNavGroup>
      ...
      <SidebarNavItem icon={faLayerGroup} href="https://www.cyberevangelists.com/contact-us">Contact with us</SidebarNavItem>
    </ul>
  )
}
